    ...
    return (
            ...
            <div className="Container">
                ...
                <div className={"wrapper-content"}>
                    ...
                    <Route path='/dialogs/dialogs.jsx' render={ () => <Dialogs state={props.state.DialogPage} addMessage={props.addMessage} updateLockTextDialogs={props.updateLockTextDialogs}/> } />
                </div>
            </div>
